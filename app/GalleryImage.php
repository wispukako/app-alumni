...
class GalleryImage extends SleepingOwlModel implements ModelWithImageFieldsInterface
{

	use SoftDeletes;
	use ModelWithImageOrFileFieldsTrait;
  protected $dates = ['deleted_at'];
  protected $fillable = array('name','image','gallery_id','description');
	protected $table = 'gallery_image';

	public static function getList()
	{
		$vals = [];
        foreach( GalleryImage::orderBy( 'id', 'asc' )->get() as $item )
